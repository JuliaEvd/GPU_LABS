...
int main() {
    ...
    const char* source = "__kernel void mykernel(__global int * input, __global int * output, const unsigned int count) {\n"
	...
	clEnqueueReadBuffer(queue, output, CL_TRUE, 0, sizeof(int) * count, results, 0, NULL, NULL);
